...
@Repository
@Profile("hsqldb")
public class HsqlJdbcMealRepositoryImpl extends AbstractJdbcMealRepositoryImpl<Timestamp> {
    ...
    @Override
    public Timestamp convertToDbDateTime(LocalDateTime localDateTime) {
